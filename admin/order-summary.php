...
if(!isset($_SESSION['productItems'])){
    echo '<script> window.location.href = "products-create.php"; </script>';

}
?>
<div class="modal fade" id="orderSuccessModal" data-bs-backdrop="static" data-bs-keybord="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <a href="orders.php" class="btn btn-secondary">Close</button>
                            ...
                            <tbody>     
                                <tr>
                                    <td style="text-align: center;" colspan="2">
                                        ...
                                        <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">#555, 1st street, 3rd cross, bandarnayaka </p>
                                        <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">company xyz pvt 1td. </p>
                                     </td>
                                 </tr>
                                 <tr>
                                    <td>
                                    ...
                                    <td align="end">
                                        ...
                                        <p style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;">Address: 1st main road, monaragala </p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
